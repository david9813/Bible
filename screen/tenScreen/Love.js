        ...
        <View style={styles.iconWrapper}>
          <View style={styles.iconContainer}>
            <TouchableOpacity onPress={() => copyVerse(item)}>
              <Ionicons name="copy-outline" size={24} color='#F8F3D4' style={styles.icon} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => shareVerse(item)}>
              <Ionicons name="share-social-outline" size={24} color='#F8F3D4' style={styles.icon} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => saveVerseAsImage(item)}>
              <Ionicons name="download-outline" size={24} color='#F8F3D4' style={styles.icon} />
            </TouchableOpacity>
          </View>
        </View>
      </View>
